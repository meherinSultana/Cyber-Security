...
int main()
{
    ...
    ////getting the pointer of inpttxt
...
//////////////permuted choice 2222and getting a single key
        for(int m=0; m<56; m++)
        {
            // cout<<array4[m]<<" ";
            int demo=pc2[m]-1;
...
//xor with initial vector
    ...
    for(int round=0; round<16; round++)
    {
        ...
        /////////////////e bit selection on r0 of 32 bit for equalizing with 48 bit key
...
/////////////////xor of expanded r0 witk k0 of both 48 bits
        ...
        //////////converting the array into 2d for easy access for s box
        int ar2d[8][6];
        int demo10=0;
        for(int i=0; i<8; i++)
        {
...
////////////////////////permutation p
    ...
    cout<<"\n\nFinal result of Encryption:"<<endl;
    int demoo=0;
    for(int i=0; i<8; i++)
    {
        for(int j=0; j<8; j++)
...
/////////////////xor of expanded r0 witk k0
        ...
        //////////converting the array for easy access for s box
        int ar2d[8][6];
        int demo10=0;
        for(int i=0; i<8; i++)
        {
    ...
    cout<<"\n\nFinal result of Decryption:"<<endl;
    int demooo=0;
    for(int i=0; i<8; i++)
    {
        for(int j=0; j<8; j++)
